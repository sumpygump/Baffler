...
var grammar = {
    Lexer: myLexer,
    ParserRules: [
    {"name": "statments", "symbols": ["statment"], "postprocess": 
        (data) => {
            return [data[0]]
        }
            },
    {"name": "statments", "symbols": ["statments", (myLexer.has("NL") ? {type: "NL"} : NL), "statment"], "postprocess": 
        (data) => {
            return [...data[0], data[2]]
        }
            },
    {"name": "statment", "symbols": ["var_assign"], "postprocess": id},
    {"name": "statment", "symbols": ["fun_call"], "postprocess": id},

...
var grammar = {
    ...
    {"name": "assignment", "symbols": [(lex.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"="}, "_", "literal"], "postprocess": 
        (data) => {
            return {
                type:     "assignment",
                var_name: data[0],
    ...
    {"name": "function_call", "symbols": [(lex.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"("}, "_", "parameter_list", "_", {"literal":")"}], "postprocess": 
        (data) => {
            return {
                type:           "function_call",
                fun_name:       data[0],
    ...
    {"name": "function_definition", "symbols": [(lex.has("identifier") ? {type: "identifier"} : identifier), "_", {"literal":"("}, "_", "parameter_list", "_", {"literal":")"}, "_", "code_block"], "postprocess": 
        (data) => {
            return {
